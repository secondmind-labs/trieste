...
class MOLocalPenalizationAcquisitionFunction(SingleModelGreedyAcquisitionBuilder[ProbabilisticModel]):
    r"""
    ...
    def __init__(
        self,
        base_acquisition_function_builder: ExpectedHypervolumeImprovement
        | ExpectedConstrainedHypervolumeImprovement
        | None = None,
    ):
        """
        Initializes the MO penalization function.
    ...
    def prepare_acquisition_function(
        ...
        :return: The MO LP acquisition function.
...
class mo_penalizer():
    r"""
    Return the local penalization function used for multi-objective greedy batch Bayesian
    optimization.
