...
class GaussianProcessRegression(
    ...
    def __init__(
        ...
        posterior: Optional[AbstractPosterior] = None,
    ):
        """
        ...
        :param posterior: Optional posterior cache to use. Normally this would be autogenerated,
            but in some cases it can be useful to pass in a pre-generated cache.
        """
