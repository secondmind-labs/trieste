...
def hartmann_3(x: TensorType) -> TensorType:
    ...
    a = tf.constant([1.0, 1.2, 3.0, 3.2] , dtype=tf.float64)
    A = tf.constant([
    	[3.0, 10.0, 30.0],
    	[0.1, 10.0, 35.0],
    	[3.0, 10.0, 30.0],
    ...
    inner_sum = -tf.reduce_sum(A*tf.math.square(tf.expand_dims(x,1)-P),-1)
