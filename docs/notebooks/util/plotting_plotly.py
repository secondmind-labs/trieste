...
def plot_dgp_plotly(model, mins: TensorType, maxs: TensorType, grid_density: int = 20,
                    num_samples: int = 100):
    """
...
def plot_bf_dgp_plotly(model, mins: TensorType, maxs: TensorType, grid_density: int = 20,
                    num_samples: int = 100):
    """
