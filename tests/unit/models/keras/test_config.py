...
from trieste.models.keras import DeepEnsemble, KerasEnsemble
...
def test_supported_neural_network_models_are_correctly_registered(
    supported_models: Tuple[Type[KerasEnsemble], Type[TrainableProbabilisticModel]]
) -> None:
